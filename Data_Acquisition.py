'''
Town01 : No route planning done , only with spawn points colletced 4 roads
Spawn point: 89,125,73,122
Speed is maintained  in 25 to 35 kmph
_________________________________________________________________________
Town02 : No route planning done, only with spwan points 
Spawn Point: 56,40,12
Speed maintained at 25 to 35 KMPh
...
def process_img(image):
    ...
    if vehicle.is_at_traffic_light():
        ...
        # print('Vehicle is cruising at {}'.format(vehicle.get_speed_limit()))
        # print("another steerin",vehicle.get_control().steer)
    cv2.imwrite('testing/Town07/%08d.jpg' % (
                    image.frame), i3)
    ...
    print('Steering angle: {steering} , Speed: {limit} km/h '.format(steering = steer_angle,limit=kmh))
    ...
    #      f.write(text_value)
    with open('testing/Town07/ground_truth.txt','a') as f:
         f.write('\n')
         f.write(text_value)
...
try:
    ...
    # route_2_indices = [131,135,333,302,122,110,106,322,13,21,368,301,332,155,184,52,199,320]
